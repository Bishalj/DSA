...
//        {
//            old.String[] strNums = br.readLine().split(" ");
...
//            {
//                old.String[] arr_initThickness = br.readLine().split(" ");
...
//            {
//                old.String[] arr_rate = br.readLine().split(" ");
...
//            }
//
//            old.String out_ = mazeTraveller(threshold, initThickness, rate, rows, cols);
...
//        br.close();
//    }
//    static old.String mazeTraveller(int threshold, int[][] initThickness, long[][] rate, int rows, int cols){
