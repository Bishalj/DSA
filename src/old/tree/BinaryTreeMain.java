...
public class BinaryTreeMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("The Height of a binary old.tree is: " + binaryTreeOperations.getTheHeightOfABinaryTree());
...
//        System.out.println();
        ...
        System.out.println();
        System.out.println("Height of the old.tree: " + binaryTreeOperations.getTheHeightOfTheTree(nodes));
        System.out.println("Height of the old.tree: " + binaryTreeOperations.getTheHeightOfTheTree2(nodes));
        System.out.println();
